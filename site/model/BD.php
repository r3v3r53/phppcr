...
class BD{
	...
	/*
	 * construtor, define as variáveis e chama o método para a conexão
	 */
...
/*
	public function getEvaluations($user_num, $starting_date, $ending_date){
		$query = sprintf("call get_avaliacoes_user( %d, %d, %d );", 
			$user_num, $starting_date, $ending_date);
...
*/
	...
	/* 
	 * efectuar uma consulta que se supõe retornar resultados
	 */
	...
	/*
	 * executar comandos mysql que não retornem resultados (insert, delete, update, etc...)
	 */
