<?php /* Smarty version Smarty-3.1.13, created on 2013-05-01 00:07:10
         compiled from ".\templates\index2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7163515decb146b209-10543762%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '7163515decb146b209-10543762',
  'function' => 
  array (
  ),
  'cache_lifetime' => 120,
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_515decb1632624_55409110',
  'variables' => 
  array (
    'SCRIPT_NAME' => 0,
    'Name' => 1,
...
<?php if ($_valid && !is_callable('content_515decb1632624_55409110')) {function content_515decb1632624_55409110($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include 'C:\\Apache\\htdocs\\bd1\\smarty\\libs\\plugins\\modifier.capitalize.php';
if (!is_callable('smarty_modifier_date_format')) include 'C:\\Apache\\htdocs\\bd1\\smarty\\libs\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_function_html_select_date')) include 'C:\\Apache\\htdocs\\bd1\\smarty\\libs\\plugins\\function.html_select_date.php';
if (!is_callable('smarty_function_html_select_time')) include 'C:\\Apache\\htdocs\\bd1\\smarty\\libs\\plugins\\function.html_select_time.php';
if (!is_callable('smarty_function_html_options')) include 'C:\\Apache\\htdocs\\bd1\\smarty\\libs\\plugins\\function.html_options.php';
...
The value of {$Name} is <b><?php echo '/*%%SmartyNocache:7163515decb146b209-10543762%%*/<?php echo $_smarty_tpl->tpl_vars[\'Name\']->value;?>
/*/%%SmartyNocache:7163515decb146b209-10543762%%*/';?>
</b>

variable modifier example of {$Name|upper}

<b><?php echo '/*%%SmartyNocache:7163515decb146b209-10543762%%*/<?php echo mb_strtoupper($_smarty_tpl->tpl_vars[\'Name\']->value, \'UTF-8\');?>
/*/%%SmartyNocache:7163515decb146b209-10543762%%*/';?>
</b>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['sec2']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['contacts']->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
	phone: <?php echo $_smarty_tpl->tpl_vars['contacts']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sec2']['index']]['phone'];?>
<br>
	fax: <?php echo $_smarty_tpl->tpl_vars['contacts']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sec2']['index']]['fax'];?>
<br>
	cell: <?php echo $_smarty_tpl->tpl_vars['contacts']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sec2']['index']]['cell'];?>
<br>
<?php endfor; endif; ?>
<p>
